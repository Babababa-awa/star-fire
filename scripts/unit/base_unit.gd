...
var unit_physics: Core.UnitPhysics = Core.UNIT_PHYSICS
var previous_unit_physics: Core.UnitPhysics = Core.UNIT_PHYSICS
...
func reset(reset_type_: Core.ResetType) -> void:
	...
	if (reset_type_ == Core.ResetType.START or 
		...
		unit_physics = Core.UNIT_PHYSICS
		previous_unit_physics = Core.UNIT_PHYSICS
